...
$classified_attributes_grid = NULL; // Initialize page object first

class cclassified_attributes_grid extends cclassified_attributes {
	...
	// Page object name
	var $PageObjName = 'classified_attributes_grid';

	// Grid form hidden field names
	var $FormName = 'fclassified_attributesgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["classified_attributes"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_classified_id") && $objForm->HasValue("o_classified_id") && $this->classified_id->CurrentValue <> $this->classified_id->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_attribute_id") && $objForm->HasValue("o_attribute_id") && $this->attribute_id->CurrentValue <> $this->attribute_id->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_attribute_value") && $objForm->HasValue("o_attribute_value") && $this->attribute_value->CurrentValue <> $this->attribute_value->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function LoadFormValues() {
		...
		$this->attribute_id->setOldValue($objForm->GetValue("o_attribute_id"));
		if (!$this->attribute_value->FldIsDetailKey) {
			$this->attribute_value->setFormValue($objForm->GetValue("x_attribute_value"));
		}
		$this->attribute_value->setOldValue($objForm->GetValue("o_attribute_value"));
