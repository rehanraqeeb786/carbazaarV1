...
$classified_attributes_add = NULL; // Initialize page object first

class cclassified_attributes_add extends cclassified_attributes {
	...
	// Page object name
	var $PageObjName = 'classified_attributes_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "classified_attributesview.php")
	...
	function LoadDefaultValues() {
		...
		$this->attribute_id->CurrentValue = NULL;
		$this->attribute_id->OldValue = $this->attribute_id->CurrentValue;
		$this->attribute_value->CurrentValue = NULL;
		$this->attribute_value->OldValue = $this->attribute_value->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// attribute_id
		$this->attribute_id->SetDbValueDef($rsnew, $this->attribute_id->CurrentValue, 0, FALSE);

		// attribute_value
		$this->attribute_value->SetDbValueDef($rsnew, $this->attribute_value->CurrentValue, "", FALSE);
...
// Create page object
if (!isset($classified_attributes_add)) $classified_attributes_add = new cclassified_attributes_add();

// Page init
$classified_attributes_add->Page_Init();

// Page main
$classified_attributes_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$classified_attributes_add->Page_Render();
?>
...
var CurrentForm = fclassified_attributesadd = new ew_Form("fclassified_attributesadd", "add");

// Validate form
fclassified_attributesadd.Validate = function() {
...
fclassified_attributesadd.Form_CustomValidate = 
...
fclassified_attributesadd.ValidateRequired = true;
<?php } else { ?>
fclassified_attributesadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fclassified_attributesadd.Lists["x_classified_id"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fclassified_attributesadd.Lists["x_attribute_id"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_attribute_title","x_attribute_type","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php $classified_attributes_add->ShowPageHeader(); ?>
<?php
$classified_attributes_add->ShowMessage();
?>
<form name="fclassified_attributesadd" id="fclassified_attributesadd" class="<?php echo $classified_attributes_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($classified_attributes_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $classified_attributes_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
fclassified_attributesadd.CreateAutoSuggest({"id":"x_classified_id","forceSelect":false});
</script>
</span>
<?php } ?>
...
<script type="text/javascript">
fclassified_attributesadd.CreateAutoSuggest({"id":"x_attribute_id","forceSelect":false});
</script>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $classified_attributes_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
fclassified_attributesadd.Init();
</script>
<?php
$classified_attributes_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$classified_attributes_add->Page_Terminate();
?>
