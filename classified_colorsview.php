...
$classified_colors_view = NULL; // Initialize page object first

class cclassified_colors_view extends cclassified_colors {
	...
	// Page object name
	var $PageObjName = 'classified_colors_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["ID"] <> "") {
				...
				$sReturnUrl = "classified_colorslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "classified_colorslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "classified_colorslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($classified_colors_view)) $classified_colors_view = new cclassified_colors_view();

// Page init
$classified_colors_view->Page_Init();

// Page main
$classified_colors_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$classified_colors_view->Page_Render();
?>
...
var CurrentForm = fclassified_colorsview = new ew_Form("fclassified_colorsview", "view");

// Form_CustomValidate event
fclassified_colorsview.Form_CustomValidate = 
...
fclassified_colorsview.ValidateRequired = true;
<?php } else { ?>
fclassified_colorsview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fclassified_colorsview.Lists["x_color_id"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fclassified_colorsview.Lists["x_classfied_id"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php $classified_colors_view->ExportOptions->Render("body") ?>
<?php
	foreach ($classified_colors_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $classified_colors_view->ShowPageHeader(); ?>
<?php
$classified_colors_view->ShowMessage();
?>
<form name="fclassified_colorsview" id="fclassified_colorsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($classified_colors_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $classified_colors_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="classified_colors">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($classified_colors->color_id->Visible) { // color_id ?>
	<tr id="r_color_id">
		<td><span id="elh_classified_colors_color_id"><?php echo $classified_colors->color_id->FldCaption() ?></span></td>
...
<?php echo $classified_colors->color_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($classified_colors->classfied_id->Visible) { // classfied_id ?>
	<tr id="r_classfied_id">
		<td><span id="elh_classified_colors_classfied_id"><?php echo $classified_colors->classfied_id->FldCaption() ?></span></td>
...
<?php echo $classified_colors->classfied_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fclassified_colorsview.Init();
</script>
<?php
$classified_colors_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$classified_colors_view->Page_Terminate();
?>
