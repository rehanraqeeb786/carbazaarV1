...
//
// Table class for ad_features
//
class cad_features extends cTable {
	var $ID;
	var $ad_id;
	var $feature_id;
	var $created_at;
	...
	function __construct() {
		...
		$this->TableVar = 'ad_features';
		$this->TableName = 'ad_features';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`ad_features`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// ID
		$this->ID = new cField('ad_features', 'ad_features', 'x_ID', 'ID', '`ID`', '`ID`', 3, -1, FALSE, '`ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ID'] = &$this->ID;

		// ad_id
		$this->ad_id = new cField('ad_features', 'ad_features', 'x_ad_id', 'ad_id', '`ad_id`', '`ad_id`', 3, -1, FALSE, '`ad_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ad_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ad_id'] = &$this->ad_id;

		// feature_id
		$this->feature_id = new cField('ad_features', 'ad_features', 'x_feature_id', 'feature_id', '`feature_id`', '`feature_id`', 3, -1, FALSE, '`feature_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->feature_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['feature_id'] = &$this->feature_id;

		// created_at
		$this->created_at = new cField('ad_features', 'ad_features', 'x_created_at', 'created_at', '`created_at`', 'DATE_FORMAT(`created_at`, \'%Y/%m/%d\')', 135, 5, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->created_at->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['created_at'] = &$this->created_at;

		// updated_at
		$this->updated_at = new cField('ad_features', 'ad_features', 'x_updated_at', 'updated_at', '`updated_at`', 'DATE_FORMAT(`updated_at`, \'%Y/%m/%d\')', 135, 5, FALSE, '`updated_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`ad_features`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("ad_featuresview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("ad_featuresview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "ad_featuresadd.php?" . $this->UrlParm($parm);
		else
			$url = "ad_featuresadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("ad_featuresedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("ad_featuresadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("ad_featuresdelete.php", $this->UrlParm());
	}
