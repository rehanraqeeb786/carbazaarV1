...
$vw_payment_api_response_view = NULL; // Initialize page object first

class cvw_payment_api_response_view extends cvw_payment_api_response {
	...
	// Page object name
	var $PageObjName = 'vw_payment_api_response_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "vw_payment_api_responselist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "vw_payment_api_responselist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "vw_payment_api_responselist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($vw_payment_api_response_view)) $vw_payment_api_response_view = new cvw_payment_api_response_view();

// Page init
$vw_payment_api_response_view->Page_Init();

// Page main
$vw_payment_api_response_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_payment_api_response_view->Page_Render();
?>
...
var CurrentForm = fvw_payment_api_responseview = new ew_Form("fvw_payment_api_responseview", "view");

// Form_CustomValidate event
fvw_payment_api_responseview.Form_CustomValidate = 
...
fvw_payment_api_responseview.ValidateRequired = true;
<?php } else { ?>
fvw_payment_api_responseview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_payment_api_responseview.Lists["x_ad_id"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_ad_title","x_demand_price","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php $vw_payment_api_response_view->ExportOptions->Render("body") ?>
<?php
	foreach ($vw_payment_api_response_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $vw_payment_api_response_view->ShowPageHeader(); ?>
<?php
$vw_payment_api_response_view->ShowMessage();
?>
<form name="fvw_payment_api_responseview" id="fvw_payment_api_responseview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_payment_api_response_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_payment_api_response_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="vw_payment_api_response">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($vw_payment_api_response->ad_id->Visible) { // ad_id ?>
	<tr id="r_ad_id">
		<td><span id="elh_vw_payment_api_response_ad_id"><?php echo $vw_payment_api_response->ad_id->FldCaption() ?></span></td>
		<td data-name="ad_id"<?php echo $vw_payment_api_response->ad_id->CellAttributes() ?>>
<span id="el_vw_payment_api_response_ad_id">
<span<?php echo $vw_payment_api_response->ad_id->ViewAttributes() ?>>
<?php echo $vw_payment_api_response->ad_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_payment_api_response->order_reference_id->Visible) { // order_reference_id ?>
	<tr id="r_order_reference_id">
		<td><span id="elh_vw_payment_api_response_order_reference_id"><?php echo $vw_payment_api_response->order_reference_id->FldCaption() ?></span></td>
...
<?php echo $vw_payment_api_response->order_reference_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_payment_api_response->transaction_id->Visible) { // transaction_id ?>
	<tr id="r_transaction_id">
		<td><span id="elh_vw_payment_api_response_transaction_id"><?php echo $vw_payment_api_response->transaction_id->FldCaption() ?></span></td>
...
<?php echo $vw_payment_api_response->transaction_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_payment_api_response->response->Visible) { // response ?>
	<tr id="r_response">
		<td><span id="elh_vw_payment_api_response_response"><?php echo $vw_payment_api_response->response->FldCaption() ?></span></td>
		<td data-name="response"<?php echo $vw_payment_api_response->response->CellAttributes() ?>>
<span id="el_vw_payment_api_response_response">
<span<?php echo $vw_payment_api_response->response->ViewAttributes() ?>>
<?php echo $vw_payment_api_response->response->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_payment_api_response->amount->Visible) { // amount ?>
	<tr id="r_amount">
		<td><span id="elh_vw_payment_api_response_amount"><?php echo $vw_payment_api_response->amount->FldCaption() ?></span></td>
...
<?php echo $vw_payment_api_response->amount->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fvw_payment_api_responseview.Init();
</script>
<?php
$vw_payment_api_response_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_payment_api_response_view->Page_Terminate();
?>
