...
$classified_pictures_add = NULL; // Initialize page object first

class cclassified_pictures_add extends cclassified_pictures {
	...
	// Page object name
	var $PageObjName = 'classified_pictures_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "classified_picturesview.php")
...
// Create page object
if (!isset($classified_pictures_add)) $classified_pictures_add = new cclassified_pictures_add();

// Page init
$classified_pictures_add->Page_Init();

// Page main
$classified_pictures_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$classified_pictures_add->Page_Render();
?>
...
var CurrentForm = fclassified_picturesadd = new ew_Form("fclassified_picturesadd", "add");

// Validate form
fclassified_picturesadd.Validate = function() {
...
fclassified_picturesadd.Form_CustomValidate = 
...
fclassified_picturesadd.ValidateRequired = true;
<?php } else { ?>
fclassified_picturesadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fclassified_picturesadd.Lists["x_classified_id"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php $classified_pictures_add->ShowPageHeader(); ?>
<?php
$classified_pictures_add->ShowMessage();
?>
<form name="fclassified_picturesadd" id="fclassified_picturesadd" class="<?php echo $classified_pictures_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($classified_pictures_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $classified_pictures_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
fclassified_picturesadd.CreateAutoSuggest({"id":"x_classified_id","forceSelect":false});
</script>
</span>
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $classified_pictures_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
fclassified_picturesadd.Init();
</script>
<?php
$classified_pictures_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$classified_pictures_add->Page_Terminate();
?>
