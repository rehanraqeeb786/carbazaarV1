...
$classified_colors_grid = NULL; // Initialize page object first

class cclassified_colors_grid extends cclassified_colors {
	...
	// Page object name
	var $PageObjName = 'classified_colors_grid';

	// Grid form hidden field names
	var $FormName = 'fclassified_colorsgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["classified_colors"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_color_id") && $objForm->HasValue("o_color_id") && $this->color_id->CurrentValue <> $this->color_id->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_classfied_id") && $objForm->HasValue("o_classfied_id") && $this->classfied_id->CurrentValue <> $this->classfied_id->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function LoadFormValues() {
		...
		$this->classfied_id->setOldValue($objForm->GetValue("o_classfied_id"));
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "classified_data") {
			$this->classfied_id->Visible = FALSE;
