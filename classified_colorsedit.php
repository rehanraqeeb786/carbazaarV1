...
$classified_colors_edit = NULL; // Initialize page object first

class cclassified_colors_edit extends cclassified_colors {
	...
	// Page object name
	var $PageObjName = 'classified_colors_edit';
	...
	function Page_Main() {
		...
		if ($this->ID->CurrentValue == "")
			$this->Page_Terminate("classified_colorslist.php"); // Invalid key, return to list
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// classfied_id
			$this->classfied_id->SetDbValueDef($rsnew, $this->classfied_id->CurrentValue, 0, $this->classfied_id->ReadOnly);
...
// Create page object
if (!isset($classified_colors_edit)) $classified_colors_edit = new cclassified_colors_edit();

// Page init
$classified_colors_edit->Page_Init();

// Page main
$classified_colors_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$classified_colors_edit->Page_Render();
?>
...
var CurrentForm = fclassified_colorsedit = new ew_Form("fclassified_colorsedit", "edit");

// Validate form
fclassified_colorsedit.Validate = function() {
...
fclassified_colorsedit.Form_CustomValidate = 
...
fclassified_colorsedit.ValidateRequired = true;
<?php } else { ?>
fclassified_colorsedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fclassified_colorsedit.Lists["x_color_id"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fclassified_colorsedit.Lists["x_classfied_id"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php $classified_colors_edit->ShowPageHeader(); ?>
<?php
$classified_colors_edit->ShowMessage();
?>
<form name="fclassified_colorsedit" id="fclassified_colorsedit" class="<?php echo $classified_colors_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($classified_colors_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $classified_colors_edit->Token ?>">
<?php } ?>
...
<script type="text/javascript">
fclassified_colorsedit.CreateAutoSuggest({"id":"x_color_id","forceSelect":false});
</script>
</span>
...
<script type="text/javascript">
fclassified_colorsedit.CreateAutoSuggest({"id":"x_classfied_id","forceSelect":false});
</script>
</span>
<?php } ?>
...
<input type="hidden" data-table="classified_colors" data-field="x_ID" name="x_ID" id="x_ID" value="<?php echo ew_HtmlEncode($classified_colors->ID->CurrentValue) ?>">
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $classified_colors_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
fclassified_colorsedit.Init();
</script>
<?php
$classified_colors_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$classified_colors_edit->Page_Terminate();
?>
