...
$ad_pictures_edit = NULL; // Initialize page object first

class cad_pictures_edit extends cad_pictures {
	...
	// Page object name
	var $PageObjName = 'ad_pictures_edit';
	...
	function Page_Main() {
		...
		if ($this->ID->CurrentValue == "")
			$this->Page_Terminate("ad_pictureslist.php"); // Invalid key, return to list
...
// Create page object
if (!isset($ad_pictures_edit)) $ad_pictures_edit = new cad_pictures_edit();

// Page init
$ad_pictures_edit->Page_Init();

// Page main
$ad_pictures_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ad_pictures_edit->Page_Render();
?>
...
var CurrentForm = fad_picturesedit = new ew_Form("fad_picturesedit", "edit");

// Validate form
fad_picturesedit.Validate = function() {
...
fad_picturesedit.Form_CustomValidate = 
...
fad_picturesedit.ValidateRequired = true;
<?php } else { ?>
fad_picturesedit.ValidateRequired = false; 
<?php } ?>
...
<?php $ad_pictures_edit->ShowPageHeader(); ?>
<?php
$ad_pictures_edit->ShowMessage();
?>
<form name="fad_picturesedit" id="fad_picturesedit" class="<?php echo $ad_pictures_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ad_pictures_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ad_pictures_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="ad_pictures" data-field="x_ID" name="x_ID" id="x_ID" value="<?php echo ew_HtmlEncode($ad_pictures->ID->CurrentValue) ?>">
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $ad_pictures_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
fad_picturesedit.Init();
</script>
<?php
$ad_pictures_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$ad_pictures_edit->Page_Terminate();
?>
