...
define("EW_PROJECT_NAME", "Car_Bazaar", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{B7B92366-0BC8-4357-900F-FDBD8A72F51D}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'UwOVfvP9fLue30Mi', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/Car_Bazaar.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "carbazaar", "qs" => "`", "qe" => "`");
...
@define("EW_USER_LEVEL_PRIV_TABLE", "`user_level_permission`", TRUE);
...
define("EW_USER_TABLE", "`adm_users`", TRUE);
define("EW_USER_NAME_FILTER", "(`user_email` = '%u')", TRUE);
define("EW_USER_ID_FILTER", "(`id` = %u)", TRUE);
define("EW_USER_EMAIL_FILTER", "(`user_email` = '%e')", TRUE);
