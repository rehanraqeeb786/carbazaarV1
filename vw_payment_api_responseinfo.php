...
$vw_payment_api_response = NULL;

//
// Table class for vw_payment_api_response
//
class cvw_payment_api_response extends cTable {
	var $id;
	var $created_at;
	var $ad_id;
	...
	function __construct() {
		...
		$this->TableVar = 'vw_payment_api_response';
		$this->TableName = 'vw_payment_api_response';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vw_payment_api_response`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('vw_payment_api_response', 'vw_payment_api_response', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// created_at
		$this->created_at = new cField('vw_payment_api_response', 'vw_payment_api_response', 'x_created_at', 'created_at', '`created_at`', 'DATE_FORMAT(`created_at`, \'%Y/%m/%d\')', 135, 5, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->created_at->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['created_at'] = &$this->created_at;

		// ad_id
		$this->ad_id = new cField('vw_payment_api_response', 'vw_payment_api_response', 'x_ad_id', 'ad_id', '`ad_id`', '`ad_id`', 3, -1, FALSE, '`ad_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ad_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ad_id'] = &$this->ad_id;

		// order_reference_id
		$this->order_reference_id = new cField('vw_payment_api_response', 'vw_payment_api_response', 'x_order_reference_id', 'order_reference_id', '`order_reference_id`', '`order_reference_id`', 200, -1, FALSE, '`order_reference_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['order_reference_id'] = &$this->order_reference_id;

		// transaction_id
		$this->transaction_id = new cField('vw_payment_api_response', 'vw_payment_api_response', 'x_transaction_id', 'transaction_id', '`transaction_id`', '`transaction_id`', 200, -1, FALSE, '`transaction_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['transaction_id'] = &$this->transaction_id;

		// response
		$this->response = new cField('vw_payment_api_response', 'vw_payment_api_response', 'x_response', 'response', '`response`', '`response`', 201, -1, FALSE, '`response`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->fields['response'] = &$this->response;

		// amount
		$this->amount = new cField('vw_payment_api_response', 'vw_payment_api_response', 'x_amount', 'amount', '`amount`', '`amount`', 3, -1, FALSE, '`amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`vw_payment_api_response`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "vw_payment_api_responselist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("vw_payment_api_responseview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("vw_payment_api_responseview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "vw_payment_api_responseadd.php?" . $this->UrlParm($parm);
		else
			$url = "vw_payment_api_responseadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("vw_payment_api_responseedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("vw_payment_api_responseadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("vw_payment_api_responsedelete.php", $this->UrlParm());
	}
