...
$cfg_classified_attribure_add = NULL; // Initialize page object first

class ccfg_classified_attribure_add extends ccfg_classified_attribure {
	...
	// Page object name
	var $PageObjName = 'cfg_classified_attribure_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "cfg_classified_attribureview.php")
	...
	function LoadDefaultValues() {
		$this->parent_attribute_id->CurrentValue = NULL;
		$this->parent_attribute_id->OldValue = $this->parent_attribute_id->CurrentValue;
		$this->attribute_title->CurrentValue = NULL;
		$this->attribute_title->OldValue = $this->attribute_title->CurrentValue;
		$this->attribute_type->CurrentValue = "feature";
	...
	function AddRow($rsold = NULL) {
		...
		// parent_attribute_id
		$this->parent_attribute_id->SetDbValueDef($rsnew, $this->parent_attribute_id->CurrentValue, NULL, FALSE);

		// attribute_title
		$this->attribute_title->SetDbValueDef($rsnew, $this->attribute_title->CurrentValue, "", FALSE);

		// attribute_type
		$this->attribute_type->SetDbValueDef($rsnew, $this->attribute_type->CurrentValue, "", strval($this->attribute_type->CurrentValue) == "");
...
// Create page object
if (!isset($cfg_classified_attribure_add)) $cfg_classified_attribure_add = new ccfg_classified_attribure_add();

// Page init
$cfg_classified_attribure_add->Page_Init();

// Page main
$cfg_classified_attribure_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cfg_classified_attribure_add->Page_Render();
?>
...
var CurrentForm = fcfg_classified_attribureadd = new ew_Form("fcfg_classified_attribureadd", "add");

// Validate form
fcfg_classified_attribureadd.Validate = function() {
...
fcfg_classified_attribureadd.Form_CustomValidate = 
...
fcfg_classified_attribureadd.ValidateRequired = true;
<?php } else { ?>
fcfg_classified_attribureadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fcfg_classified_attribureadd.Lists["x_parent_attribute_id"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_attribute_title","x_attribute_type","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcfg_classified_attribureadd.Lists["x_attribute_type"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcfg_classified_attribureadd.Lists["x_attribute_type"].Options = <?php echo json_encode($cfg_classified_attribure->attribute_type->Options()) ?>;
fcfg_classified_attribureadd.Lists["x_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcfg_classified_attribureadd.Lists["x_status"].Options = <?php echo json_encode($cfg_classified_attribure->status->Options()) ?>;
...
<?php $cfg_classified_attribure_add->ShowPageHeader(); ?>
<?php
$cfg_classified_attribure_add->ShowMessage();
?>
<form name="fcfg_classified_attribureadd" id="fcfg_classified_attribureadd" class="<?php echo $cfg_classified_attribure_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cfg_classified_attribure_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cfg_classified_attribure_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
fcfg_classified_attribureadd.CreateAutoSuggest({"id":"x_parent_attribute_id","forceSelect":false});
</script>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cfg_classified_attribure_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
fcfg_classified_attribureadd.Init();
</script>
<?php
$cfg_classified_attribure_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$cfg_classified_attribure_add->Page_Terminate();
?>
