...
$vw_approved_ads_list = NULL;

//
// Table class for vw_approved_ads_list
//
class cvw_approved_ads_list extends cTable {
	var $ID;
	var $user_id;
	var $ad_title;
	var $year_id;
	...
	function __construct() {
		...
		$this->TableVar = 'vw_approved_ads_list';
		$this->TableName = 'vw_approved_ads_list';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vw_approved_ads_list`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// ID
		$this->ID = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_ID', 'ID', '`ID`', '`ID`', 3, -1, FALSE, '`ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ID'] = &$this->ID;

		// user_id
		$this->user_id = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 3, -1, FALSE, '`user_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['user_id'] = &$this->user_id;

		// ad_title
		$this->ad_title = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_ad_title', 'ad_title', '`ad_title`', '`ad_title`', 200, -1, FALSE, '`ad_title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['ad_title'] = &$this->ad_title;

		// year_id
		$this->year_id = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_year_id', 'year_id', '`year_id`', '`year_id`', 3, -1, FALSE, '`year_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->year_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['year_id'] = &$this->year_id;

		// registered_in
		$this->registered_in = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_registered_in', 'registered_in', '`registered_in`', '`registered_in`', 3, -1, FALSE, '`registered_in`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->fields['registered_in'] = &$this->registered_in;

		// city_id
		$this->city_id = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_city_id', 'city_id', '`city_id`', '`city_id`', 3, -1, FALSE, '`city_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->city_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['city_id'] = &$this->city_id;

		// make_id
		$this->make_id = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_make_id', 'make_id', '`make_id`', '`make_id`', 3, -1, FALSE, '`make_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->make_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['make_id'] = &$this->make_id;

		// model_id
		$this->model_id = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_model_id', 'model_id', '`model_id`', '`model_id`', 3, -1, FALSE, '`model_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->model_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['model_id'] = &$this->model_id;

		// version_id
		$this->version_id = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_version_id', 'version_id', '`version_id`', '`version_id`', 3, -1, FALSE, '`version_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->version_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['version_id'] = &$this->version_id;

		// milage
		$this->milage = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_milage', 'milage', '`milage`', '`milage`', 3, -1, FALSE, '`milage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->milage->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['milage'] = &$this->milage;

		// color_id
		$this->color_id = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_color_id', 'color_id', '`color_id`', '`color_id`', 3, -1, FALSE, '`color_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->color_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['color_id'] = &$this->color_id;

		// demand_price
		$this->demand_price = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_demand_price', 'demand_price', '`demand_price`', '`demand_price`', 3, -1, FALSE, '`demand_price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->demand_price->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['demand_price'] = &$this->demand_price;

		// details
		$this->details = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_details', 'details', '`details`', '`details`', 201, -1, FALSE, '`details`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->fields['details'] = &$this->details;

		// engine_type_id
		$this->engine_type_id = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_engine_type_id', 'engine_type_id', '`engine_type_id`', '`engine_type_id`', 3, -1, FALSE, '`engine_type_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->engine_type_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['engine_type_id'] = &$this->engine_type_id;

		// engine_capicity
		$this->engine_capicity = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_engine_capicity', 'engine_capicity', '`engine_capicity`', '`engine_capicity`', 3, -1, FALSE, '`engine_capicity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->engine_capicity->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['engine_capicity'] = &$this->engine_capicity;

		// transmition
		$this->transmition = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_transmition', 'transmition', '`transmition`', '`transmition`', 202, -1, FALSE, '`transmition`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->transmition->OptionCount = 2;
		$this->fields['transmition'] = &$this->transmition;

		// assembly
		$this->assembly = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_assembly', 'assembly', '`assembly`', '`assembly`', 202, -1, FALSE, '`assembly`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->assembly->OptionCount = 2;
		$this->fields['assembly'] = &$this->assembly;

		// mobile_number
		$this->mobile_number = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_mobile_number', 'mobile_number', '`mobile_number`', '`mobile_number`', 200, -1, FALSE, '`mobile_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['mobile_number'] = &$this->mobile_number;

		// secondary_number
		$this->secondary_number = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_secondary_number', 'secondary_number', '`secondary_number`', '`secondary_number`', 200, -1, FALSE, '`secondary_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['secondary_number'] = &$this->secondary_number;

		// email
		$this->_email = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['email'] = &$this->_email;

		// name
		$this->name = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['name'] = &$this->name;

		// address
		$this->address = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_address', 'address', '`address`', '`address`', 200, -1, FALSE, '`address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['address'] = &$this->address;

		// allow_whatsapp
		$this->allow_whatsapp = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_allow_whatsapp', 'allow_whatsapp', '`allow_whatsapp`', '`allow_whatsapp`', 202, -1, FALSE, '`allow_whatsapp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// status
		$this->status = new cField('vw_approved_ads_list', 'vw_approved_ads_list', 'x_status', 'status', '`status`', '`status`', 202, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`vw_approved_ads_list`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "vw_approved_ads_listlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("vw_approved_ads_listview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("vw_approved_ads_listview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "vw_approved_ads_listadd.php?" . $this->UrlParm($parm);
		else
			$url = "vw_approved_ads_listadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("vw_approved_ads_listedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("vw_approved_ads_listadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("vw_approved_ads_listdelete.php", $this->UrlParm());
	}
