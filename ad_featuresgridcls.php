...
$ad_features_grid = NULL; // Initialize page object first

class cad_features_grid extends cad_features {
	...
	// Page object name
	var $PageObjName = 'ad_features_grid';

	// Grid form hidden field names
	var $FormName = 'fad_featuresgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["ad_features"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_ad_id") && $objForm->HasValue("o_ad_id") && $this->ad_id->CurrentValue <> $this->ad_id->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_feature_id") && $objForm->HasValue("o_feature_id") && $this->feature_id->CurrentValue <> $this->feature_id->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function LoadFormValues() {
		...
		$this->ad_id->setOldValue($objForm->GetValue("o_ad_id"));
		if (!$this->feature_id->FldIsDetailKey) {
			$this->feature_id->setFormValue($objForm->GetValue("x_feature_id"));
		}
		$this->feature_id->setOldValue($objForm->GetValue("o_feature_id"));
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "car_ads") {
			$this->ad_id->Visible = FALSE;
			if ($GLOBALS["car_ads"]->EventCancelled) $this->EventCancelled = TRUE;
		}
