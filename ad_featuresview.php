...
$ad_features_view = NULL; // Initialize page object first

class cad_features_view extends cad_features {
	...
	// Page object name
	var $PageObjName = 'ad_features_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["ID"] <> "") {
				...
				$sReturnUrl = "ad_featureslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "ad_featureslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "ad_featureslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($ad_features_view)) $ad_features_view = new cad_features_view();

// Page init
$ad_features_view->Page_Init();

// Page main
$ad_features_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ad_features_view->Page_Render();
?>
...
var CurrentForm = fad_featuresview = new ew_Form("fad_featuresview", "view");

// Form_CustomValidate event
fad_featuresview.Form_CustomValidate = 
...
fad_featuresview.ValidateRequired = true;
<?php } else { ?>
fad_featuresview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fad_featuresview.Lists["x_ad_id"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_ad_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fad_featuresview.Lists["x_feature_id"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_feature_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php $ad_features_view->ExportOptions->Render("body") ?>
<?php
	foreach ($ad_features_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $ad_features_view->ShowPageHeader(); ?>
<?php
$ad_features_view->ShowMessage();
?>
<form name="fad_featuresview" id="fad_featuresview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ad_features_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ad_features_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="ad_features">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($ad_features->ad_id->Visible) { // ad_id ?>
	<tr id="r_ad_id">
		<td><span id="elh_ad_features_ad_id"><?php echo $ad_features->ad_id->FldCaption() ?></span></td>
...
<?php echo $ad_features->ad_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($ad_features->feature_id->Visible) { // feature_id ?>
	<tr id="r_feature_id">
		<td><span id="elh_ad_features_feature_id"><?php echo $ad_features->feature_id->FldCaption() ?></span></td>
...
<?php echo $ad_features->feature_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fad_featuresview.Init();
</script>
<?php
$ad_features_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$ad_features_view->Page_Terminate();
?>
