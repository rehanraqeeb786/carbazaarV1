...
$classified_pictures_grid = NULL; // Initialize page object first

class cclassified_pictures_grid extends cclassified_pictures {
	...
	// Page object name
	var $PageObjName = 'classified_pictures_grid';

	// Grid form hidden field names
	var $FormName = 'fclassified_picturesgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["classified_pictures"];
