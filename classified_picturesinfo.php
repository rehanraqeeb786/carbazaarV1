...
$classified_pictures = NULL;

//
// Table class for classified_pictures
//
class cclassified_pictures extends cTable {
	var $ID;
	var $picture_link;
	var $classified_id;
	var $ETD;
	...
	function __construct() {
		...
		$this->TableVar = 'classified_pictures';
		$this->TableName = 'classified_pictures';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`classified_pictures`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// ID
		$this->ID = new cField('classified_pictures', 'classified_pictures', 'x_ID', 'ID', '`ID`', '`ID`', 3, -1, FALSE, '`ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ID'] = &$this->ID;

		// picture_link
		$this->picture_link = new cField('classified_pictures', 'classified_pictures', 'x_picture_link', 'picture_link', '`picture_link`', '`picture_link`', 200, -1, TRUE, '`picture_link`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->fields['picture_link'] = &$this->picture_link;

		// classified_id
		$this->classified_id = new cField('classified_pictures', 'classified_pictures', 'x_classified_id', 'classified_id', '`classified_id`', '`classified_id`', 3, -1, FALSE, '`classified_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->classified_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['classified_id'] = &$this->classified_id;

		// ETD
		$this->ETD = new cField('classified_pictures', 'classified_pictures', 'x_ETD', 'ETD', '`ETD`', 'DATE_FORMAT(`ETD`, \'%Y/%m/%d\')', 135, 5, FALSE, '`ETD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`classified_pictures`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "classified_pictureslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("classified_picturesview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("classified_picturesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "classified_picturesadd.php?" . $this->UrlParm($parm);
		else
			$url = "classified_picturesadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("classified_picturesedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("classified_picturesadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("classified_picturesdelete.php", $this->UrlParm());
	}
