...
//
// Table class for car_ads
//
class ccar_ads extends cTable {
	var $ID;
	var $user_id;
	var $ad_title;
	var $year_id;
	...
	function __construct() {
		...
		$this->TableVar = 'car_ads';
		$this->TableName = 'car_ads';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`car_ads`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// ID
		$this->ID = new cField('car_ads', 'car_ads', 'x_ID', 'ID', '`ID`', '`ID`', 3, -1, FALSE, '`ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ID'] = &$this->ID;

		// user_id
		$this->user_id = new cField('car_ads', 'car_ads', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 3, -1, FALSE, '`user_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['user_id'] = &$this->user_id;

		// ad_title
		$this->ad_title = new cField('car_ads', 'car_ads', 'x_ad_title', 'ad_title', '`ad_title`', '`ad_title`', 200, -1, FALSE, '`ad_title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['ad_title'] = &$this->ad_title;

		// year_id
		$this->year_id = new cField('car_ads', 'car_ads', 'x_year_id', 'year_id', '`year_id`', '`year_id`', 3, -1, FALSE, '`year_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->year_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['year_id'] = &$this->year_id;

		// registered_in
		$this->registered_in = new cField('car_ads', 'car_ads', 'x_registered_in', 'registered_in', '`registered_in`', '`registered_in`', 3, -1, FALSE, '`registered_in`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->fields['registered_in'] = &$this->registered_in;

		// city_id
		$this->city_id = new cField('car_ads', 'car_ads', 'x_city_id', 'city_id', '`city_id`', '`city_id`', 3, -1, FALSE, '`city_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->city_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['city_id'] = &$this->city_id;

		// make_id
		$this->make_id = new cField('car_ads', 'car_ads', 'x_make_id', 'make_id', '`make_id`', '`make_id`', 3, -1, FALSE, '`make_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->make_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['make_id'] = &$this->make_id;

		// model_id
		$this->model_id = new cField('car_ads', 'car_ads', 'x_model_id', 'model_id', '`model_id`', '`model_id`', 3, -1, FALSE, '`model_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->model_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['model_id'] = &$this->model_id;

		// version_id
		$this->version_id = new cField('car_ads', 'car_ads', 'x_version_id', 'version_id', '`version_id`', '`version_id`', 3, -1, FALSE, '`version_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->version_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['version_id'] = &$this->version_id;

		// milage
		$this->milage = new cField('car_ads', 'car_ads', 'x_milage', 'milage', '`milage`', '`milage`', 3, -1, FALSE, '`milage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->milage->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['milage'] = &$this->milage;

		// color_id
		$this->color_id = new cField('car_ads', 'car_ads', 'x_color_id', 'color_id', '`color_id`', '`color_id`', 3, -1, FALSE, '`color_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->color_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['color_id'] = &$this->color_id;

		// demand_price
		$this->demand_price = new cField('car_ads', 'car_ads', 'x_demand_price', 'demand_price', '`demand_price`', '`demand_price`', 3, -1, FALSE, '`demand_price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->demand_price->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['demand_price'] = &$this->demand_price;

		// details
		$this->details = new cField('car_ads', 'car_ads', 'x_details', 'details', '`details`', '`details`', 201, -1, FALSE, '`details`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->fields['details'] = &$this->details;

		// engine_type_id
		$this->engine_type_id = new cField('car_ads', 'car_ads', 'x_engine_type_id', 'engine_type_id', '`engine_type_id`', '`engine_type_id`', 3, -1, FALSE, '`engine_type_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->engine_type_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['engine_type_id'] = &$this->engine_type_id;

		// engine_capicity
		$this->engine_capicity = new cField('car_ads', 'car_ads', 'x_engine_capicity', 'engine_capicity', '`engine_capicity`', '`engine_capicity`', 3, -1, FALSE, '`engine_capicity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->engine_capicity->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['engine_capicity'] = &$this->engine_capicity;

		// transmition
		$this->transmition = new cField('car_ads', 'car_ads', 'x_transmition', 'transmition', '`transmition`', '`transmition`', 202, -1, FALSE, '`transmition`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->transmition->OptionCount = 2;
		$this->fields['transmition'] = &$this->transmition;

		// assembly
		$this->assembly = new cField('car_ads', 'car_ads', 'x_assembly', 'assembly', '`assembly`', '`assembly`', 202, -1, FALSE, '`assembly`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->assembly->OptionCount = 2;
		$this->fields['assembly'] = &$this->assembly;

		// mobile_number
		$this->mobile_number = new cField('car_ads', 'car_ads', 'x_mobile_number', 'mobile_number', '`mobile_number`', '`mobile_number`', 200, -1, FALSE, '`mobile_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['mobile_number'] = &$this->mobile_number;

		// secondary_number
		$this->secondary_number = new cField('car_ads', 'car_ads', 'x_secondary_number', 'secondary_number', '`secondary_number`', '`secondary_number`', 200, -1, FALSE, '`secondary_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['secondary_number'] = &$this->secondary_number;

		// email
		$this->_email = new cField('car_ads', 'car_ads', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['email'] = &$this->_email;

		// name
		$this->name = new cField('car_ads', 'car_ads', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['name'] = &$this->name;

		// address
		$this->address = new cField('car_ads', 'car_ads', 'x_address', 'address', '`address`', '`address`', 200, -1, FALSE, '`address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['address'] = &$this->address;

		// allow_whatsapp
		$this->allow_whatsapp = new cField('car_ads', 'car_ads', 'x_allow_whatsapp', 'allow_whatsapp', '`allow_whatsapp`', '`allow_whatsapp`', 202, -1, FALSE, '`allow_whatsapp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// status
		$this->status = new cField('car_ads', 'car_ads', 'x_status', 'status', '`status`', '`status`', 202, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->status->OptionCount = 5;
		$this->fields['status'] = &$this->status;

		// created_at
		$this->created_at = new cField('car_ads', 'car_ads', 'x_created_at', 'created_at', '`created_at`', 'DATE_FORMAT(`created_at`, \'%Y/%m/%d\')', 135, 5, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->created_at->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['created_at'] = &$this->created_at;

		// updated_at
		$this->updated_at = new cField('car_ads', 'car_ads', 'x_updated_at', 'updated_at', '`updated_at`', 'DATE_FORMAT(`updated_at`, \'%Y/%m/%d\')', 135, 5, FALSE, '`updated_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "ad_features") {
			$sDetailUrl = $GLOBALS["ad_features"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_ID=" . urlencode($this->ID->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "ad_pictures") {
			$sDetailUrl = $GLOBALS["ad_pictures"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_ID=" . urlencode($this->ID->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "car_adslist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`car_ads`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("car_adsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("car_adsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "car_adsadd.php?" . $this->UrlParm($parm);
		else
			$url = "car_adsadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("car_adsedit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("car_adsedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("car_adsadd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("car_adsadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("car_adsdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		//need to get make, model , year and variat from db

		$fetch_make = ew_executeScalar("SELECT cfg_make_companies.title FROM cfg_make_companies WHERE cfg_make_companies.ID = ".$rsnew["make_id"]);
		$fetch_model = ew_executeScalar("SELECT cfg_models.title FROM cfg_models WHERE cfg_models.ID = ".$rsnew["model_id"]);
		$fetch_year = ew_executeScalar("SELECT cfg_years.year FROM cfg_years WHERE cfg_years.ID = ".$rsnew["model_id"]);
		$fetch_varient = ew_executeScalar("SELECT cfg_car_versions.title FROM cfg_car_versions WHERE cfg_car_versions.ID =".$rsnew["make_id"]);

		//ad title should be make-model-year-varient-for sale
		$rsnew["ad_title"] = $fetch_make.' '.$fetch_model.' '.$fetch_year.' '.$fetch_varient.' for sale';
		return TRUE;
	}
