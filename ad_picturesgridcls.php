...
$ad_pictures_grid = NULL; // Initialize page object first

class cad_pictures_grid extends cad_pictures {
	...
	// Page object name
	var $PageObjName = 'ad_pictures_grid';

	// Grid form hidden field names
	var $FormName = 'fad_picturesgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["ad_pictures"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadDefaultValues() {
		...
		$this->picture_link->Upload->Index = $this->RowIndex;
	}
	...
	function RenderRow() {
		...
		$this->picture_link->ViewCustomAttributes = "";
			...
			if (is_numeric($this->RowIndex) && !$this->EventCancelled) ew_RenderUploadField($this->picture_link, $this->RowIndex);
