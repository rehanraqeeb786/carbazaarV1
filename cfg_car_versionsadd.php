...
$cfg_car_versions_add = NULL; // Initialize page object first

class ccfg_car_versions_add extends ccfg_car_versions {
	...
	// Page object name
	var $PageObjName = 'cfg_car_versions_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "cfg_car_versionsview.php")
...
// Create page object
if (!isset($cfg_car_versions_add)) $cfg_car_versions_add = new ccfg_car_versions_add();

// Page init
$cfg_car_versions_add->Page_Init();

// Page main
$cfg_car_versions_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cfg_car_versions_add->Page_Render();
?>
...
var CurrentForm = fcfg_car_versionsadd = new ew_Form("fcfg_car_versionsadd", "add");

// Validate form
fcfg_car_versionsadd.Validate = function() {
...
fcfg_car_versionsadd.Form_CustomValidate = 
...
fcfg_car_versionsadd.ValidateRequired = true;
<?php } else { ?>
fcfg_car_versionsadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fcfg_car_versionsadd.Lists["x_make_id"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_title","","",""],"ParentFields":[],"ChildFields":["x_model_id"],"FilterFields":[],"Options":[],"Template":""};
fcfg_car_versionsadd.Lists["x_model_id"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_title","","",""],"ParentFields":["x_make_id"],"ChildFields":[],"FilterFields":["x_make_company_id"],"Options":[],"Template":""};
fcfg_car_versionsadd.Lists["x_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcfg_car_versionsadd.Lists["x_status"].Options = <?php echo json_encode($cfg_car_versions->status->Options()) ?>;
...
<?php $cfg_car_versions_add->ShowPageHeader(); ?>
<?php
$cfg_car_versions_add->ShowMessage();
?>
<form name="fcfg_car_versionsadd" id="fcfg_car_versionsadd" class="<?php echo $cfg_car_versions_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cfg_car_versions_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cfg_car_versions_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ew_CreateEditor("fcfg_car_versionsadd", "x_details", 35, 4, <?php echo ($cfg_car_versions->details->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cfg_car_versions_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
fcfg_car_versionsadd.Init();
</script>
<?php
$cfg_car_versions_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$cfg_car_versions_add->Page_Terminate();
?>
