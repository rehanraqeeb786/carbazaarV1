...
$payment_transactions_view = NULL; // Initialize page object first

class cpayment_transactions_view extends cpayment_transactions {
	...
	// Page object name
	var $PageObjName = 'payment_transactions_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "payment_transactionslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "payment_transactionslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "payment_transactionslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($payment_transactions_view)) $payment_transactions_view = new cpayment_transactions_view();

// Page init
$payment_transactions_view->Page_Init();

// Page main
$payment_transactions_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$payment_transactions_view->Page_Render();
?>
...
var CurrentForm = fpayment_transactionsview = new ew_Form("fpayment_transactionsview", "view");

// Form_CustomValidate event
fpayment_transactionsview.Form_CustomValidate = 
...
fpayment_transactionsview.ValidateRequired = true;
<?php } else { ?>
fpayment_transactionsview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fpayment_transactionsview.Lists["x_ad_id"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_ad_title","x_demand_price","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpayment_transactionsview.Lists["x_package_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_package_fee","x_number_of_days","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpayment_transactionsview.Lists["x_pay_method_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpayment_transactionsview.Lists["x_bank_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_bank_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpayment_transactionsview.Lists["x_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpayment_transactionsview.Lists["x_status"].Options = <?php echo json_encode($payment_transactions->status->Options()) ?>;
...
<?php $payment_transactions_view->ExportOptions->Render("body") ?>
<?php
	foreach ($payment_transactions_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $payment_transactions_view->ShowPageHeader(); ?>
<?php
$payment_transactions_view->ShowMessage();
?>
<form name="fpayment_transactionsview" id="fpayment_transactionsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($payment_transactions_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $payment_transactions_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="payment_transactions">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($payment_transactions->ad_id->Visible) { // ad_id ?>
	<tr id="r_ad_id">
		<td><span id="elh_payment_transactions_ad_id"><?php echo $payment_transactions->ad_id->FldCaption() ?></span></td>
...
<?php echo $payment_transactions->ad_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($payment_transactions->package_id->Visible) { // package_id ?>
	<tr id="r_package_id">
		<td><span id="elh_payment_transactions_package_id"><?php echo $payment_transactions->package_id->FldCaption() ?></span></td>
...
<?php echo $payment_transactions->package_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($payment_transactions->pay_method_id->Visible) { // pay_method_id ?>
	<tr id="r_pay_method_id">
		<td><span id="elh_payment_transactions_pay_method_id"><?php echo $payment_transactions->pay_method_id->FldCaption() ?></span></td>
...
<?php echo $payment_transactions->pay_method_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($payment_transactions->bank_id->Visible) { // bank_id ?>
	<tr id="r_bank_id">
		<td><span id="elh_payment_transactions_bank_id"><?php echo $payment_transactions->bank_id->FldCaption() ?></span></td>
...
<?php echo $payment_transactions->bank_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($payment_transactions->transaction_id->Visible) { // transaction_id ?>
	<tr id="r_transaction_id">
		<td><span id="elh_payment_transactions_transaction_id"><?php echo $payment_transactions->transaction_id->FldCaption() ?></span></td>
...
<?php echo $payment_transactions->transaction_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($payment_transactions->order_reference_id->Visible) { // order_reference_id ?>
	<tr id="r_order_reference_id">
		<td><span id="elh_payment_transactions_order_reference_id"><?php echo $payment_transactions->order_reference_id->FldCaption() ?></span></td>
...
<?php echo $payment_transactions->order_reference_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($payment_transactions->amount->Visible) { // amount ?>
	<tr id="r_amount">
		<td><span id="elh_payment_transactions_amount"><?php echo $payment_transactions->amount->FldCaption() ?></span></td>
...
<?php echo $payment_transactions->amount->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($payment_transactions->response->Visible) { // response ?>
	<tr id="r_response">
		<td><span id="elh_payment_transactions_response"><?php echo $payment_transactions->response->FldCaption() ?></span></td>
		<td data-name="response"<?php echo $payment_transactions->response->CellAttributes() ?>>
<span id="el_payment_transactions_response">
<span<?php echo $payment_transactions->response->ViewAttributes() ?>>
<?php echo $payment_transactions->response->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($payment_transactions->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_payment_transactions_status"><?php echo $payment_transactions->status->FldCaption() ?></span></td>
		<td data-name="status"<?php echo $payment_transactions->status->CellAttributes() ?>>
<span id="el_payment_transactions_status">
<span<?php echo $payment_transactions->status->ViewAttributes() ?>>
<?php echo $payment_transactions->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fpayment_transactionsview.Init();
</script>
<?php
$payment_transactions_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$payment_transactions_view->Page_Terminate();
?>
