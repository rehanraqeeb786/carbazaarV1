...
class cuser_levels_list extends cuser_levels {
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $Language->Phrase("SearchPanel") . "\" data-caption=\"" . $Language->Phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fuser_levelslistsrch\">" . $Language->Phrase("SearchBtn") . "</button>";
		$item->Visible = TRUE;
...
fuser_levelslist.ValidateRequired = true;
<?php } else { ?>
fuser_levelslist.ValidateRequired = false; 
<?php } ?>
...
<?php
	...
	if ($user_levels->CurrentAction == "" && $user_levels_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$user_levels_list->setWarningMessage($Language->Phrase("NoPermission"));
...
<form name="fuser_levelslistsrch" id="fuser_levelslistsrch" class="form-inline ewForm" action="<?php echo ew_CurrentPage() ?>">
...
<?php } ?>
<input type="hidden" name="t" value="user_levels">
<div id="gmp_user_levels" class="<?php if (ew_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
...
<?php if ($user_levels->user_level_id->Visible) { // user_level_id ?>
	<?php if ($user_levels->SortUrl($user_levels->user_level_id) == "") { ?>
		<th data-name="user_level_id"><div id="elh_user_levels_user_level_id" class="user_levels_user_level_id"><div class="ewTableHeaderCaption"><?php echo $user_levels->user_level_id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="user_level_id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user_levels->SortUrl($user_levels->user_level_id) ?>',1);"><div id="elh_user_levels_user_level_id" class="user_levels_user_level_id">
...
<?php if ($user_levels->user_level_name->Visible) { // user_level_name ?>
	<?php if ($user_levels->SortUrl($user_levels->user_level_name) == "") { ?>
		<th data-name="user_level_name"><div id="elh_user_levels_user_level_name" class="user_levels_user_level_name"><div class="ewTableHeaderCaption"><?php echo $user_levels->user_level_name->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="user_level_name"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user_levels->SortUrl($user_levels->user_level_name) ?>',1);"><div id="elh_user_levels_user_level_name" class="user_levels_user_level_name">
...
<a id="<?php echo $user_levels_list->PageObjName . "_row_" . $user_levels_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($user_levels->user_level_name->Visible) { // user_level_name ?>
