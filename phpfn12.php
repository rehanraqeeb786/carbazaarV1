...
function CurrentProjectID() {
	...
	return "{B7B92366-0BC8-4357-900F-FDBD8A72F51D}";
}
...
class cAdvancedSecurity {
			...
			if ($rs = $UserTableConn->Execute($sSql)) {
				if (!$rs->EOF) {
					...
					if ($ValidateUser) {
						...
						$this->setCurrentUserName($rs->fields('user_email')); // Load user name
	...
	function CurrentUserEmail() {
		return $this->CurrentUserInfo("user_email");
	}
