...
fuser_levelsedit.ValidateRequired = true;
<?php } else { ?>
fuser_levelsedit.ValidateRequired = false; 
<?php } ?>
...
<?php if ($user_levels->user_level_id->Visible) { // user_level_id ?>
	<div id="r_user_level_id" class="form-group">
		<label id="elh_user_levels_user_level_id" for="x_user_level_id" class="col-sm-2 control-label ewLabel"><?php echo $user_levels->user_level_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $user_levels->user_level_id->CellAttributes() ?>>
...
<?php if ($user_levels->user_level_name->Visible) { // user_level_name ?>
	<div id="r_user_level_name" class="form-group">
		<label id="elh_user_levels_user_level_name" for="x_user_level_name" class="col-sm-2 control-label ewLabel"><?php echo $user_levels->user_level_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $user_levels->user_level_name->CellAttributes() ?>>
<span id="el_user_levels_user_level_name">
<input type="text" data-table="user_levels" data-field="x_user_level_name" name="x_user_level_name" id="x_user_level_name" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($user_levels->user_level_name->getPlaceHolder()) ?>" value="<?php echo $user_levels->user_level_name->EditValue ?>"<?php echo $user_levels->user_level_name->EditAttributes() ?>>
</span>
