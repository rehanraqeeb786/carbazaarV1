...
$cfg_cities_edit = NULL; // Initialize page object first

class ccfg_cities_edit extends ccfg_cities {
	...
	// Page object name
	var $PageObjName = 'cfg_cities_edit';
	...
	function Page_Main() {
		...
		if ($this->ID->CurrentValue == "")
			$this->Page_Terminate("cfg_citieslist.php"); // Invalid key, return to list
...
// Create page object
if (!isset($cfg_cities_edit)) $cfg_cities_edit = new ccfg_cities_edit();

// Page init
$cfg_cities_edit->Page_Init();

// Page main
$cfg_cities_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cfg_cities_edit->Page_Render();
?>
...
var CurrentForm = fcfg_citiesedit = new ew_Form("fcfg_citiesedit", "edit");

// Validate form
fcfg_citiesedit.Validate = function() {
...
fcfg_citiesedit.Form_CustomValidate = 
...
fcfg_citiesedit.ValidateRequired = true;
<?php } else { ?>
fcfg_citiesedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fcfg_citiesedit.Lists["x_province_id"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_province_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcfg_citiesedit.Lists["x_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcfg_citiesedit.Lists["x_status"].Options = <?php echo json_encode($cfg_cities->status->Options()) ?>;
...
<?php $cfg_cities_edit->ShowPageHeader(); ?>
<?php
$cfg_cities_edit->ShowMessage();
?>
<form name="fcfg_citiesedit" id="fcfg_citiesedit" class="<?php echo $cfg_cities_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cfg_cities_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cfg_cities_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="cfg_cities" data-field="x_ID" name="x_ID" id="x_ID" value="<?php echo ew_HtmlEncode($cfg_cities->ID->CurrentValue) ?>">
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cfg_cities_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
fcfg_citiesedit.Init();
</script>
<?php
$cfg_cities_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$cfg_cities_edit->Page_Terminate();
?>
