...
class cchangepwd extends cadm_users {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["adm_users"])) $GLOBALS["adm_users"] = &$this;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 'adm_users');
		}
	...
	function Page_Main() {
		...
		if ($bPostBack && $bValidate) {
			...
			// SQL constructor in adm_users class, adm_usersinfo.php
