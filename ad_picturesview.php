...
$ad_pictures_view = NULL; // Initialize page object first

class cad_pictures_view extends cad_pictures {
	...
	// Page object name
	var $PageObjName = 'ad_pictures_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["ID"] <> "") {
				...
				$sReturnUrl = "ad_pictureslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "ad_pictureslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "ad_pictureslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($ad_pictures_view)) $ad_pictures_view = new cad_pictures_view();

// Page init
$ad_pictures_view->Page_Init();

// Page main
$ad_pictures_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ad_pictures_view->Page_Render();
?>
...
var CurrentForm = fad_picturesview = new ew_Form("fad_picturesview", "view");

// Form_CustomValidate event
fad_picturesview.Form_CustomValidate = 
...
fad_picturesview.ValidateRequired = true;
<?php } else { ?>
fad_picturesview.ValidateRequired = false; 
<?php } ?>
...
<?php $ad_pictures_view->ExportOptions->Render("body") ?>
<?php
	foreach ($ad_pictures_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $ad_pictures_view->ShowPageHeader(); ?>
<?php
$ad_pictures_view->ShowMessage();
?>
<form name="fad_picturesview" id="fad_picturesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ad_pictures_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ad_pictures_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="ad_pictures">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($ad_pictures->ad_id->Visible) { // ad_id ?>
	<tr id="r_ad_id">
		<td><span id="elh_ad_pictures_ad_id"><?php echo $ad_pictures->ad_id->FldCaption() ?></span></td>
...
<?php echo $ad_pictures->ad_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($ad_pictures->picture_link->Visible) { // picture_link ?>
	<tr id="r_picture_link">
		<td><span id="elh_ad_pictures_picture_link"><?php echo $ad_pictures->picture_link->FldCaption() ?></span></td>
...
<?php echo ew_GetFileViewTag($ad_pictures->picture_link, $ad_pictures->picture_link->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<script type="text/javascript">
fad_picturesview.Init();
</script>
<?php
$ad_pictures_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$ad_pictures_view->Page_Terminate();
?>
