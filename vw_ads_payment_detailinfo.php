...
$vw_ads_payment_detail = NULL;

//
// Table class for vw_ads_payment_detail
//
class cvw_ads_payment_detail extends cTable {
	var $created_at;
	var $ad_id;
	var $amount;
	var $package_id;
	...
	function __construct() {
		...
		$this->TableVar = 'vw_ads_payment_detail';
		$this->TableName = 'vw_ads_payment_detail';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vw_ads_payment_detail`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// created_at
		$this->created_at = new cField('vw_ads_payment_detail', 'vw_ads_payment_detail', 'x_created_at', 'created_at', '`created_at`', 'DATE_FORMAT(`created_at`, \'%Y/%m/%d\')', 135, 5, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->created_at->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['created_at'] = &$this->created_at;

		// ad_id
		$this->ad_id = new cField('vw_ads_payment_detail', 'vw_ads_payment_detail', 'x_ad_id', 'ad_id', '`ad_id`', '`ad_id`', 3, -1, FALSE, '`ad_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ad_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ad_id'] = &$this->ad_id;

		// amount
		$this->amount = new cField('vw_ads_payment_detail', 'vw_ads_payment_detail', 'x_amount', 'amount', '`amount`', '`amount`', 3, -1, FALSE, '`amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->amount->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['amount'] = &$this->amount;

		// package_id
		$this->package_id = new cField('vw_ads_payment_detail', 'vw_ads_payment_detail', 'x_package_id', 'package_id', '`package_id`', '`package_id`', 3, -1, FALSE, '`package_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->package_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['package_id'] = &$this->package_id;

		// pay_method_id
		$this->pay_method_id = new cField('vw_ads_payment_detail', 'vw_ads_payment_detail', 'x_pay_method_id', 'pay_method_id', '`pay_method_id`', '`pay_method_id`', 3, -1, FALSE, '`pay_method_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->pay_method_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['pay_method_id'] = &$this->pay_method_id;

		// bank_id
		$this->bank_id = new cField('vw_ads_payment_detail', 'vw_ads_payment_detail', 'x_bank_id', 'bank_id', '`bank_id`', '`bank_id`', 3, -1, FALSE, '`bank_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->bank_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['bank_id'] = &$this->bank_id;

		// transaction_id
		$this->transaction_id = new cField('vw_ads_payment_detail', 'vw_ads_payment_detail', 'x_transaction_id', 'transaction_id', '`transaction_id`', '`transaction_id`', 200, -1, FALSE, '`transaction_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['transaction_id'] = &$this->transaction_id;

		// order_reference_id
		$this->order_reference_id = new cField('vw_ads_payment_detail', 'vw_ads_payment_detail', 'x_order_reference_id', 'order_reference_id', '`order_reference_id`', '`order_reference_id`', 200, -1, FALSE, '`order_reference_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`vw_ads_payment_detail`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "vw_ads_payment_detaillist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("vw_ads_payment_detailview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("vw_ads_payment_detailview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "vw_ads_payment_detailadd.php?" . $this->UrlParm($parm);
		else
			$url = "vw_ads_payment_detailadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("vw_ads_payment_detailedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("vw_ads_payment_detailadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("vw_ads_payment_detaildelete.php", $this->UrlParm());
	}
