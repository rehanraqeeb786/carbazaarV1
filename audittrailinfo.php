...
class caudittrail extends cTable {
	...
	function __construct() {
		...
		// datetime
		$this->datetime = new cField('audittrail', 'audittrail', 'x_datetime', 'datetime', '`datetime`', 'DATE_FORMAT(`datetime`, \'%Y/%m/%d\')', 135, 5, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->datetime->EditValue = ew_FormatDateTime($this->datetime->CurrentValue, 5);
