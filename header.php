...
//for logo change by rehan
$(".ewHeaderRow img").attr('src','phpimages/mkr_logo.png')
$(".ewHeaderRow img").attr('style','opacity:1 !important')
$(".ewFooterText").text('@2021 CarBazaar Pvt Ltd. | v1.0 | All rights reserved.');

//add username in top header
$( "#ewHeaderRow" ).append( "<p class='log_user_name'><?php echo CurrentUserInfo('user_email') ?></p>" );
})
</script>
