...
fuserssearch.Lists["x_user_level"] = {"LinkField":"x_user_level_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_user_level_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fuserssearch.Lists["x_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fuserssearch.Lists["x_status"].Options = <?php echo json_encode($users->status->Options()) ?>;
...
<?php if ($users->user_email->Visible) { // user_email ?>
	<div id="r_user_email" class="form-group">
		<label for="x_user_email" class="<?php echo $users_search->SearchLabelClass ?>"><span id="elh_users_user_email"><?php echo $users->user_email->FldCaption() ?></span>	
		...
		<div class="<?php echo $users_search->SearchRightColumnClass ?>"><div<?php echo $users->user_email->CellAttributes() ?>>
...
<?php if ($users->user_level->Visible) { // user_level ?>
	<div id="r_user_level" class="form-group">
		<label for="x_user_level" class="<?php echo $users_search->SearchLabelClass ?>"><span id="elh_users_user_level"><?php echo $users->user_level->FldCaption() ?></span>	
		...
		<div class="<?php echo $users_search->SearchRightColumnClass ?>"><div<?php echo $users->user_level->CellAttributes() ?>>
...
<div class="ewDropdownList has-feedback">
	<span onclick="" class="form-control dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
		<?php echo $users->user_level->AdvancedSearch->ViewValue ?>
	</span>
...
if (is_array($arwrk)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($users->user_level->AdvancedSearch->SearchValue) == strval($arwrk[$rowcntwrk][0])) ? " checked" : "";
		if ($selwrk <> "") {
			$emptywrk = FALSE;
?>
...
<?php if ($users->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label class="<?php echo $users_search->SearchLabelClass ?>"><span id="elh_users_status"><?php echo $users->status->FldCaption() ?></span>	
		...
		<div class="<?php echo $users_search->SearchRightColumnClass ?>"><div<?php echo $users->status->CellAttributes() ?>>
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($users->status->AdvancedSearch->SearchValue) == strval($arwrk[$rowcntwrk][0])) ? " checked" : "";
		if ($selwrk <> "")
			$emptywrk = FALSE;
?>
