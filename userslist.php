...
class cusers_list extends cusers {
	...
	function GetFilterList() {
		...
		// Initialize
		$sFilterList = "";
		$sFilterList = ew_Concat($sFilterList, $this->user_email->AdvancedSearch->ToJSON(), ","); // Field user_email
	...
	function AdvancedSearchWhere($Default = FALSE) {
		...
		$this->BuildSearchSql($sWhere, $this->user_email, $Default, FALSE); // user_email
	...
	function LoadSearchValues() {
		...
		$this->user_email->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_user_email"]);
		if ($this->user_email->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->user_email->AdvancedSearch->SearchOperator = @$_GET["z_user_email"];
...
fuserslist.Lists["x_user_level"] = {"LinkField":"x_user_level_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_user_level_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
fuserslist.Lists["x_status"].Options = <?php echo json_encode($users->status->Options()) ?>;
...
<?php if ($users->user_email->Visible) { // user_email ?>
	<?php if ($users->SortUrl($users->user_email) == "") { ?>
		<th data-name="user_email"><div id="elh_users_user_email" class="users_user_email"><div class="ewTableHeaderCaption"><?php echo $users->user_email->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="user_email"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->user_email) ?>',1);"><div id="elh_users_user_email" class="users_user_email">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->user_email->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($users->user_email->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->user_email->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($users->password->Visible) { // password ?>
	<?php if ($users->SortUrl($users->password) == "") { ?>
		<th data-name="password"><div id="elh_users_password" class="users_password"><div class="ewTableHeaderCaption"><?php echo $users->password->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="password"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->password) ?>',1);"><div id="elh_users_password" class="users_password">
...
<?php if ($users->user_level->Visible) { // user_level ?>
	<?php if ($users->SortUrl($users->user_level) == "") { ?>
		<th data-name="user_level"><div id="elh_users_user_level" class="users_user_level"><div class="ewTableHeaderCaption"><?php echo $users->user_level->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="user_level"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->user_level) ?>',1);"><div id="elh_users_user_level" class="users_user_level">
...
<?php if ($users->status->Visible) { // status ?>
	<?php if ($users->SortUrl($users->status) == "") { ?>
		<th data-name="status"><div id="elh_users_status" class="users_status"><div class="ewTableHeaderCaption"><?php echo $users->status->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="status"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->status) ?>',1);"><div id="elh_users_status" class="users_status">
...
?>
	<?php if ($users->user_email->Visible) { // user_email ?>
		<td data-name="user_email"<?php echo $users->user_email->CellAttributes() ?>>
<span id="el<?php echo $users_list->RowCnt ?>_users_user_email" class="users_user_email">
<span<?php echo $users->user_email->ViewAttributes() ?>>
<?php echo $users->user_email->ListViewValue() ?></span>
</span>
