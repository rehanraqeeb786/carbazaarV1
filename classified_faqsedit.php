...
$classified_faqs_edit = NULL; // Initialize page object first

class cclassified_faqs_edit extends cclassified_faqs {
	...
	// Page object name
	var $PageObjName = 'classified_faqs_edit';
	...
	function Page_Main() {
		...
		if ($this->ID->CurrentValue == "")
			$this->Page_Terminate("classified_faqslist.php"); // Invalid key, return to list
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// question_text
			$this->question_text->SetDbValueDef($rsnew, $this->question_text->CurrentValue, "", $this->question_text->ReadOnly);
...
// Create page object
if (!isset($classified_faqs_edit)) $classified_faqs_edit = new cclassified_faqs_edit();

// Page init
$classified_faqs_edit->Page_Init();

// Page main
$classified_faqs_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$classified_faqs_edit->Page_Render();
?>
...
var CurrentForm = fclassified_faqsedit = new ew_Form("fclassified_faqsedit", "edit");

// Validate form
fclassified_faqsedit.Validate = function() {
...
fclassified_faqsedit.Form_CustomValidate = 
...
fclassified_faqsedit.ValidateRequired = true;
<?php } else { ?>
fclassified_faqsedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fclassified_faqsedit.Lists["x_classified_id"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php $classified_faqs_edit->ShowPageHeader(); ?>
<?php
$classified_faqs_edit->ShowMessage();
?>
<form name="fclassified_faqsedit" id="fclassified_faqsedit" class="<?php echo $classified_faqs_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($classified_faqs_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $classified_faqs_edit->Token ?>">
<?php } ?>
...
<script type="text/javascript">
fclassified_faqsedit.CreateAutoSuggest({"id":"x_classified_id","forceSelect":false});
</script>
</span>
<?php } ?>
...
<input type="hidden" data-table="classified_faqs" data-field="x_ID" name="x_ID" id="x_ID" value="<?php echo ew_HtmlEncode($classified_faqs->ID->CurrentValue) ?>">
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $classified_faqs_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
fclassified_faqsedit.Init();
</script>
<?php
$classified_faqs_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$classified_faqs_edit->Page_Terminate();
?>
